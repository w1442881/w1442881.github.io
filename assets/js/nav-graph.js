(() => {
  ...
  var require_iterate = __commonJS({
    "node_modules/graphology-layout-force/iterate.js"(exports, module) {
      ...
      module.exports = function iterate(graph2, nodeStates, params) {
        ...
        for (let i = 0; i < adjustedOrder; i++) {
          ...
          if (!isNodeFixed.fromGraph(graph2, n)) {
  ...
  var require_helpers = __commonJS({
    "node_modules/graphology-layout-force/helpers.js"(exports) {
      exports.assignLayoutChanges = function(graph2, nodeStates, params) {
  ...
  var require_worker = __commonJS({
    "node_modules/graphology-layout-force/worker.js"(exports, module) {
      ...
      function ForceSupervisor2(graph2, params) {
        if (!isGraph2(graph2))
          throw new Error(
...
`
  ...
  var Sigma$1 = /* @__PURE__ */ function(_TypedEventEmitter) {
    ...
    function Sigma2(graph2, container) {
      var _this;
  ...
  // src/client/engineering-design/nav-graph.ts
  ...
  var sigma;
  var containerDiv = document.getElementById("sigma-container");
  var graph = new import_graphology.default();
  graph.import(navGraph);
  graph.nodes().forEach((x) => {
    graph.setNodeAttribute(x, "x", 10 * Math.random());
    graph.setNodeAttribute(x, "y", 10 * Math.random());
  });
  sigma = new Sigma(
    graph,
    containerDiv,
  ...
  sigma.on("clickNode", function(e) {
    const node = e.node;
    if (graph.getNodeAttribute(node, "url", true)) {
      window.open(graph.getNodeAttribute(node, "url", true), "_top");
    }
  });
  sigma.refresh();
