(() => {
  ...
  function indexToColor(index2) {
    if (typeof FLOAT_INDEX_CACHE[index2] !== "undefined") return FLOAT_INDEX_CACHE[index2];
    var r = (index2 & 16711680) >>> 16;
    var g = (index2 & 65280) >>> 8;
    var b = index2 & 255;
    var a = 255;
    var color = rgbaToFloat(r, g, b, a, true);
    FLOAT_INDEX_CACHE[index2] = color;
    return color;
  }
...
`
  ...
  var Sigma$1 = /* @__PURE__ */ function(_TypedEventEmitter) {
    ...
    _createClass(Sigma2, [{
      ...
      value: function getNodeAtPosition(position) {
        ...
        var index2 = colorToIndex.apply(void 0, _toConsumableArray(color));
        var itemAt = this.itemIDsIndex[index2];
  ...
  // src/client/samples/graph-editor-json.ts
  ...
  var writeToJsonButton = document.getElementById("write-to-json");
  var readFromJsonButton = document.getElementById("read-from-json");
  var jsonCodeTextarea = document.getElementById("json-code-textarea");
  var graphB = new import_graphology.default();
  var sigma;
  readFromJsonButton.addEventListener("click", () => {
    const graphData = JSON.parse(jsonCodeTextarea.value);
    const containerDiv = document.getElementById("sigma-container");
    graphB = new import_graphology.default();
    graphB.import(graphData);
    sigma = new Sigma(
      graphB,
      containerDiv,
      {
  ...
  writeToJsonButton.addEventListener("click", () => {
    console.log(sigma);
    const graphData = JSON.stringify(sigma.getGraph(), null, 4);
    jsonCodeTextarea.value = graphData;
  });
})();
