...
`;
  ...
  var mySiteNavigation = [
    { caption: "Home", url: "/", subItems: [] },
    {
      caption: "DSU",
      subItems: [
        { caption: "Main", url: "/dsu", subItems: [] },
        { caption: "Applications", url: "/dsu/apps", subItems: [] },
        { caption: "Framework", url: "/dsu/framework", subItems: [] }
      ]
    },
    // { caption: "DSU", url:"/dsu", subItems: [] },
    { caption: "Ref", url: "/ref", subItems: [] },
    { caption: "Samples", url: "/samples", subItems: [] },
    { caption: "Personal", url: "/personal", subItems: [] },
    { caption: "Angular sanity check", url: "/sanity-check", subItems: [] },
    // {
    //     caption: "Graph editor", subItems: [
    //         { caption: "Current editor", url: "graph-editor", subItems: [] },
    //         { caption: "CRUD json", url: "graph-editor-json", subItems: [] },
    //     ]
    // },
    // {
    //     caption: "REST", subItems: [
    //         { caption: "Rest sample", url: "rest-sample", subItems: [] },                    
    //         { caption: "Rest/web socket", url: "websockets", subItems: [] },                    
    //     ]
    // },
    // {
    //     caption: "Other samples", subItems: [
    //         { caption: "Inheritance sample", url: "inheritance-sample", subItems: [] },                    
    //         { caption: "Nav generation", url: "inheritance-nav-test", subItems: [] },                    
    //         { caption: "React w/tsx", url: "react-test", subItems: [] },                    
    //         { caption: "Tabulator test", url: "tabulator-test", subItems: [] },
    //     ]
    // },
    { caption: "Sitemap", url: "sitemap.html", subItems: [] }
  ];
